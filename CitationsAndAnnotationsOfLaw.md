Notes and resources for approaches to data structure, tagging, citations and annotations for legal data sets, including statutes, regulations, ordinances, policies and contracts.  
